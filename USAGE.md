...
<dl>
 ...
 <dt>平均法</dt>
  <dd>1にすると，Lanczos3法の代わりに画素平均法を使ってリサイズします．</dd>
 <dt>ドット数でサイズ指定</dt>
...
<dl>
 ...
 <dt>縦/横</dt>
  <dd><code>0</code>なら縦スクロール，<code>1</code>なら横スクロールします．</dd>
 <dt>表示長</dt>
  <dd>表示させる領域のサイズ(縦なら高さ，横なら幅)を指定します．オブジェクトのサイズより大きい場合は何もしません．</dd>
 <dt>拡大</dt>
  <dd><code>1</code>なら領域拡張を行い，再生位置<code>0</code>および<code>100</code>がなにも見えない状態になります．</dd>
</dt>
